...
std::vector<Element> GetElements()
{
	...
	elements.push_back(Element_INDC());
	elements.push_back(Element_INDI());
	elements.push_back(Element_H3());
	elements.push_back(Element_RVRS());
	elements.push_back(Element_SAMR());
	elements.push_back(Element_ERGY());
	elements.push_back(Element_NUKE());
	return elements;
}
