...
class Element_INDC: public Element
{
public:
	Element_INDC();
	virtual ~Element_INDC();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_INDI: public Element
{
public:
	Element_INDI();
	virtual ~Element_INDI();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_H3: public Element
{
public:
	Element_H3();
	virtual ~Element_H3();
...
class Element_SAMR: public Element
{
public:
	Element_SAMR();
	virtual ~Element_SAMR();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_ERGY: public Element
{
public:
	Element_ERGY();
	virtual ~Element_ERGY();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_NUKE: public Element
{
public:
	Element_NUKE();
	virtual ~Element_NUKE();
	static int update(UPDATE_FUNC_ARGS);
};
