...
//#TPT-Directive ElementClass Element_H3 PT_H3 181
Element_H3::Element_H3()
{
	Identifier = "DEFAULT_PT_H3";
	Name = "SLH2";
...
//#TPT-Directive ElementHeader Element_H3 static int update(UPDATE_FUNC_ARGS)
int Element_H3::update(UPDATE_FUNC_ARGS)
{
	int r,rx,ry,rt;
	for (rx=-2; rx<3; rx++)
		for (ry=-2; ry<3; ry++)
