...
int Element_WARP::update(UPDATE_FUNC_ARGS)
 {
	...
	for ( trade = 0; trade<5; trade ++)
	{
		...
		if (BOUNDS_CHECK && (rx || ry))
		{
			...
			if (!r)
				continue;
			if ((r&0xFF)!=PT_WARP&&(r&0xFF)!=PT_STKM&&(r&0xFF)!=PT_STKM2&&(r&0xFF)!=PT_DMND&&(r&0xFF)!=PT_CLNE&&(r&0xFF)!=PT_BCLN&&(r&0xFF)!=PT_PCLN&&(r&0xFF)!=PT_INDC&&(r&0xFF)!=PT_SPRK&&(r&0xFF)!=PT_INDI)
			{
